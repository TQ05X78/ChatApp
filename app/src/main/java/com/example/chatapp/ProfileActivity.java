...
public class ProfileActivity extends AppCompatActivity {
    ...
    androidx.appcompat.widget.Toolbar mtoolbarforviewprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile);
         ...
         mtoolbarforviewprofile = findViewById(R.id.toolbarofviewprofile);
         mbackbuttonofviewprofile = findViewById(R.id.backbittonofviewprofile);
         firebaseDatabase = FirebaseDatabase.getInstance();
         firebaseAuth = FirebaseAuth.getInstance();
         firebaseStorage = FirebaseStorage.getInstance();

         setSupportActionBar(mtoolbarforviewprofile);
    ...
    protected void onStop() {
        ...
        documentReference.update("status", "Offline").addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(getApplicationContext(), "New User is Offline", Toast.LENGTH_SHORT).show();
            }
        });
    }
