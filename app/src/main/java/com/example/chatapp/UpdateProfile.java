...
public class UpdateProfile extends AppCompatActivity {
    ...
    private androidx.appcompat.widget.Toolbar mtoolbarforupdateprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mtoolbarforupdateprofile = findViewById(R.id.toolbarofupdateprofile);
       mbackbuttonofupdateprofile = findViewById(R.id.backbittonofudateprofile);
       mgetnewimageinimageview = findViewById(R.id.updateuserimageinimageview);
       mprogressbarofupdateprofile = findViewById(R.id.progressforupdateprofile);
       mnewusername = findViewById(R.id.updatenewusername);
       ...
       intent = getIntent();
       setSupportActionBar(mtoolbarforupdateprofile);
